...
//FIXME: Add detailed note that ALL players would know
...
export const Countries: Location[] = [
    ...
    },
    {
        ...
        pronunciation: "meta-vis-ee-um commonwealth",
...
export const Towns: Location[] = [
    {
        ...
        description: [
            `Hundreds of years ago, this was a thriving town that hosted all manner of miners, villagers, traders and more who worked alongside others in the Phandelver Mine. However, an orc raid completely razed the town as well as the mine and all settlements around it, leaving nothing but ruins and fire. With the location of the mine lost and death at every turn, the town was abandoned for centuries and all but forgotten.`,
            `With the supposed recent discovery of a map leading to the long-forgotten Phandelver Mine a new town has been built over the top of the old one by those hopeful to uncover wealth in the area.`,
            ``,
            `As a frontier town it is no stranger to its fair share of issues and had to contend with an unsavoury groups of bandits called Redbrands causing chaos. Until the party stepped in and put a stop to their cowardly acts, freeing the town from oppression and bringing joy to the townsfolk.`,
        ],
        type: "Town",
    },
    {
    ...
    //FIXME: Add details for:
    // Profaned Capital
    // _wherever Petee is from (small farming town)_
    // _wherever Kaldoris is from (magical town on Zyxs)_
    // _wherever Sync is from_ (feywilds town, read Discord for details) <-- Will not show up on the map though :3
    // {
    //     id: "",
    //     name: "",
    //     pronunciation: "",
...
export const PlacesOfInterest: Location[] = [
    {
        ...
        pronunciation: "roo-ins of thun-der-tree",
        ...
        description: [
            `Once a prosperous community of woodcutters and trappers, a magical mishap caused the destruction of the town and zombification of several residents. Fearing for their lives, those who didn't perish fled leaving the town to wither and crumble away.`,
            `Now it is home to various animals and plants as nature works to recover a land devoid of civilian activities.`,
            ``,
            `Once a frequent hideout for Reidoth, after a dragon settled the area the party was contacted to scare it off and restore peace. However the great beast - Venomfang - was unwilling to listen to reason and so was subsequently slain.`,
            `Now the town is empty again, save for the giant spiders that make their nest under the town, and the twig blights that occasionally roam through the empty streets.`
        ],
        type: "Town",
    },
    //FIXME: Add details for:
    // _all the locations the party has encountered in the LMoP module!_
    // {
    //     id: "",
    //     name: "",
    //     pronunciation: "",
